...
source_path = "/home/lyndon/.gemini/antigravity/brain/7934c526-168d-49f4-a90d-70f5e96b8a5b/uploaded_image_1764533339623.jpg"
...
def remove_checkerboard(img):
    ...
    for item in datas:
        ...
        # Allow small variance for compression artifacts (JPEG has more artifacts)
        is_gray = abs(r - g) < 30 and abs(r - b) < 30 and abs(g - b) < 30
        
        # If it's gray and not bright white (text), make it transparent
        # The text is white (255, 255, 255), so we want to keep high brightness.
        # The background checkerboard seems to be dark/medium gray.
