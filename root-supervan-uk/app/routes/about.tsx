        ...
        <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-indigo prose-lg text-slate-500">
                <p className="text-lg text-slate-900 mb-6">
                    Welcome to <strong>SuperVan Digital</strong>, your premier destination for exploring the cutting edge of technology, artificial intelligence, and digital innovation.
                </p>
                ...
                <h2 className="text-2xl font-semibold text-slate-900 mt-8 mb-4">The Team</h2>
                <p className="text-slate-500 mb-6">
