...
export function meta({ }: Route.MetaArgs) {
    return [
        { title: "Terms of Service - Supervan.uk" },
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-invert max-w-none text-slate-300">
                ...
                <p className="mb-4">
                    Questions about the Terms of Service should be sent to us at <a href="mailto:contact@supervan.uk" className="text-purple-400 hover:text-purple-300">contact@supervan.uk</a>.
                </p>
            </div>
        </div>
    );
