...
export function meta({ }: Route.MetaArgs) {
    return [
        { title: "Contact Us - SuperVan Digital" },
        { name: "description", content: "Get in touch with the SuperVan Digital team." },
    ];
}
            ...
            <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div>
                        ...
                        <a href="mailto:contact@supervan.uk" className="text-indigo-600 hover:text-indigo-500 text-lg font-medium transition-colors">
                            contact@supervan.uk
                        </a>
                        ...
                        <div className="mt-8">
                            ...
                            <div className="flex space-x-4">
                                <a href="https://github.com/supervan" className="text-slate-500 hover:text-indigo-600 transition-colors">GitHub</a>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            <div>
                                ...
                                <input
                                    ...
                                    id="name"
                                    required
                                    className="w-full bg-slate-50 border border-slate-300 rounded-lg px-4 py-2 text-slate-900 focus:outline-none focus:border-indigo-500 transition-colors"
